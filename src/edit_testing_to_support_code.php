...
if(isset($_POST['edit_testing']) && $have_write_permission) {
  ...
  if($retval != NULL) {
    ...
    //we add the entry.
     $update_query = "UPDATE testing_to_support_code SET test_description='". mysql_real_escape_string($_POST['description']) . "',administered_by='" . addslashes($_POST['administered_by']) ."',date='" . addslashes($_POST['date']) . "',recommendations='" . addslashes($_POST['recommendations']) . "'";
