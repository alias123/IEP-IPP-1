...
if(isset($_POST['edit_coordination_of_services'])) {
  ...
  if($retval != NULL) {
    ...
    //we add the entry.
    $insert_query = "UPDATE coordination_of_services SET agency='" . mysql_real_escape_string($_POST['agency']) . "',date='" . addslashes($_POST['date']) . "',description='" . addslashes($_POST['description']) . "'";
